...
import type {Instance} from 'react-dom-bindings/src/client/ReactDOMHostConfig';
...
export const setRefreshHandler: (handler: RefreshHandler | null) => void =
  enableNewReconciler ? setRefreshHandler_new : setRefreshHandler_old;
export const resolveFunctionForHotReloading: typeof resolveFunctionForHotReloading_new =
  enableNewReconciler
...
export const resolveForwardRefForHotReloading: typeof resolveForwardRefForHotReloading_new =
  enableNewReconciler
...
export const markFailedErrorBoundaryForHotReloading: (fiber: Fiber) => void =
  enableNewReconciler
